...
//Board class is where most of the "meat" of the game information is.
public class Board extends JPanel implements MouseListener 
{
	...
	//This is used as the backend for the GUI.
	...
	//Where moves and other mouse clicks are handled
	...
	//this adds the holes to the board
		...
		//This function is mainly used for AI
		...
		//fullTurn implements not only a normal turn, but also special cases,
		//such as second turns.
		...
		//the frame where the user chooses to make a pie move or not.
		...
		//implements the timer for the clients.
		public void Time()
		{
